...
public class Customer {
    ...
    // 1. 멤버변수 : 객체내 속성 값을 저장할 변수 , 접근제한자 타입 static 변수명
        // 접근제한자
        // private : 다른 클래스부터 접근제한 , 현재 클래스에서만 호출이 가능하다.
        // public : 다른 클래스로부터 접근가능 , 현재 다른 클래스에서도 호출이 가능.
        // 정적변수
